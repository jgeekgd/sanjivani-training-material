...
public class Inbox extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String inboxUser = (String) session.getAttribute("UN");
			String inboxUserPass = (String) session.getAttribute("UP");

			out.println("<hr>Welcome " + inboxUser + "!");
			out.println("</br>Inbox Mail Page");
