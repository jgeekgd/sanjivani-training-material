...
public class Compose extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			out.println("<html>");
			out.println("<head>");
			out.println("<title>Compose Mail Page</title>");
			out.println("</head>");
			out.println("<body>");
			...
			String composeUser = (String) session.getAttribute("UN");
			String composeUserPass = (String) session.getAttribute("UP");

			out.println("<hr>Welcome " + composeUser + "!");
			out.println("</br>Compose Mail Page");
