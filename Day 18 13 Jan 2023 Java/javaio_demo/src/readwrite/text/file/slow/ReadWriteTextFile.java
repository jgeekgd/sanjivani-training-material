package readwrite.text.file.slow;
...
public class ReadWriteTextFile {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			writer.write("The way to get started is to quit talking and begin doing.");
			writer.write("\r\n"); // write new line
		...
		System.out.println("File copied check path:" + new File("Quotes_Copy.txt").getCanonicalPath());
