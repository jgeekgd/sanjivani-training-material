...
import com.gd.objectmapper.model.Country;
import com.gd.objectmapper.model.Info;
...
public class ObjectMapperUtils {
	...
	public static void jsonInFileToObject() throws IOException {
		Country countryFromFile = objectMapper.readValue(Util.getFileFromResource("country.json"), Country.class);
