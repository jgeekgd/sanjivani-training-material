...
public class WordDocument {
	...
	public static String output = "gd_with_maven.docx";
	...
	public void handleSimpleDoc() throws Exception {
		...
		Path imagePath = Paths.get(Thread.currentThread().getContextClassLoader().getResource(logo).toURI());
		...
		FileOutputStream out = new FileOutputStream(new File(output).getAbsolutePath());
		document.write(out);
		out.close();
		document.close();

		System.out.println("Word Document Created Sucessfully..");
		System.out.println("Check Location: " + new File(output).getAbsolutePath());
	...
	public static void main(String[] args) throws Exception {
		new WordDocument().handleSimpleDoc();
